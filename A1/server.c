...
int main(int argc, char const *argv[]) 
{
	...
	FILE* file = fopen(argv[1],"r+");	//r for both write and read operation
		...
		//...........................otherwise...........................
			...
			if(strcmp(string, "EVALUATEX") == 0){
				...
				for( int i = 0; i < strlen(str3); i++){
					if(!isdigit(str3[i])){
						strcpy(message, "SERVER: INVALID INPUT!!! K should be an integer!\n");
			...
			//---------------------------------------------for WRITEX----------------------------------------
				...
				if(!valid_expression(&buffer[7])){
					...
					if(!check_expression(&buffer[7], argv[1], count_lines)){
